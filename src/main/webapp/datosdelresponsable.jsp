    ...
    <div class="Elbori">
      <form class="row g-3" id="formddr" onsubmit="return validar();">
        ...
        <div class="col-md-6">
           ...
           <input type="text" maxlength="30" class="form-control" id="completname" placeholder="Nombre completo" required> 
         </div>
  
         <div class="col-md-5">
           <label for="stall" class="form-label">Puesto</label>
         ...
         <div class="col-md-6">
           ...
           <input type="text" maxlength="30" class="form-control" id="area" placeholder="Área" required>
         </div>
        ...
        <div class="col-md-5">
          ...
          <input type="email"  maxlength="35" class="form-control" id="email" placeholder="Correo" required>
        </div>

        <div class="col-md-5">
          <label for="cellphone" class="form-label">No.Celular</label>       
          <input type="number" maxlength="20" class="form-control" id="cellphone" placeholder="No.Celular" required>
        </div>
